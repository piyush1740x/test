...
const Treatment = () => {
  return (
    <section id="treatments" className="py-16 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-gray-700 mb-6 leading-relaxed anm3">
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 anm3">1. फैक्टर रिप्लेसमेंट थेरेपी</h3>
            ...
            <ul className="list-disc pl-6 text-lg text-gray-700 space-y-2 anm3">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 anm3">2. ब्लीडिंग एपिसोड्स का इलाज</h3>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          {/* Surgery */}
          <div>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 anm3">3. सर्जरी</h3>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          {/* Gene Therapy */}
          <div>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 anm3">4. जीन थेरेपी (Gene Therapy)</h3>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 anm3">5. दवाइयाँ और सप्लीमेंट्स</h3>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          {/* Lifestyle and Care */}
          <div>
            <h3 className="text-2xl font-semibold text-red-600 mb-4 anm3">6. जीवनशैली और देखभाल</h3>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
